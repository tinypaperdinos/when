...
Read `.claude/tickets/<slug>/ticket.md` and the approved `.claude/tickets/<slug>/plan.md`.
...
- Commit as you go with clear, conventional commit messages. Don't push — the
  orchestrator handles branch push and PR creation.
