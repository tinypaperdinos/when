    ...
    <button
      ...
      className={
        ...
        (checked
          ...
          : "bg-paper shadow-[3px_3px_0_0_var(--color-ink)]")
      }
    ...
    <main className="mx-auto max-w-3xl space-y-8 p-8">
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-start justify-between border-2 border-ink bg-paper p-3 shadow-[3px_3px_0_0_var(--color-ink)]">
            <div>
          ...
          <div className="flex items-start justify-between border-2 border-ink bg-paper p-3 shadow-[3px_3px_0_0_var(--color-ink)] opacity-60">
            <div>
      ...
      <section className="space-y-2">
        ...
        <div className="flex gap-2">
          <input
            className="flex-1 border-2 border-ink bg-paper px-3 py-2 font-mono shadow-[inset_2px_2px_0_0_var(--color-line)] outline-none focus-visible:outline-dashed focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
